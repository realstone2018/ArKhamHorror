...
public class ItemList : MonoBehaviour {
        ...
        public ItemList (int _ItemId, string _name, int _CheckNum, int _WeaponType, string _ItemText,int _price,int _HandNum,Sprite _ItemImage)
        {
            this.ItemId = _ItemId;
            this.name = _name;
